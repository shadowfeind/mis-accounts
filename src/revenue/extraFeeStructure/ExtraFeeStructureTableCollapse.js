...
const ExtraFeeStructureTableCollapse = ({ item, updateCollegeHandler }) => {
              ...
              <Grid container>
                <Grid item md={6}>
                  <List key={item.$id * 0.002}>
                    <ListItem>
                      <strong>Extra Fee Name</strong>:{item.AccountName}
                    </ListItem>
                    <ListItem>
...
export default ExtraFeeStructureTableCollapse;
