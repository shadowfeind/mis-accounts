...
const AdmissionFeeStructureTableCollapse = ({
  item,
  idAccount,
  ...
  const IdAccountName = idAccount?.filter((s) => s.Key === item.IdAccountGroup);
                ...
                <Grid item md={6}>
                  <List key={item.$id * 0.002}>
                    <ListItem>
                      ...
                      {IdAccountName?.length > 0 && IdAccountName[0]?.Value}
                    </ListItem>
                    <ListItem>
                      <strong>Account Name</strong>: {item.AccountName}
                    </ListItem>
                    <ListItem>
                      <strong>Account Name Description</strong>:{" "}
                      {item.AccountNameDesc}
                    </ListItem>
                    <ListItem>
...
export default AdmissionFeeStructureTableCollapse;
